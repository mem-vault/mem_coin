...
module mem_coin::subscription_token;
...
/// Allow marketplace-like trade (payment and ownership transfer)
#[allow(lint(custom_state_change))]
entry fun trade_subscription(
    sub: Subscription, 
    buyer: address, 
    price: Coin<MEM_COIN>, 
    ctx: &TxContext
    ...
    transfer::public_transfer(price, ctx.sender()); 
    transfer::transfer(sub, buyer);
}
